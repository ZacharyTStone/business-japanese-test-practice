...
values ('3abf299a57', 0, '研修センター', 'surface_keyword_match', '「研修」という言葉は同じだが、これは9日の実技研修の場所で、2日目の話ではない。', null),
       ...
       ('aa772d5814', 2, '17部', 'surface_keyword_match', '「十七」は日付の数字で、部数ではない。', null),
