...
values ('5d536c8392', 'sougou_dokkai_J2_001', 'sougou_dokkai', 'J2', 'client_escalation+staff_to_visitor+infer_cause@J2', 'client_escalation', 'staff_to_visitor', 'infer_cause', 'written', null, null, null, '苦情の本当の理由', '先方が困っているのは、何が原因ですか。', 2, '「品物そのものに問題はございませんでした」「数量も注文どおり」と、何が原因でないかを先に並べてから「ただ、」で本題に入る型。原因は到着時刻で、そのために検品が翌朝になり、立ち上げが1日ずれている。丁寧な苦情ほど、原因は「ただ」のあとに来る。', 'A polite complaint clears away what is not the problem first; the cause follows ただ.', '[{"term": "検品", "reading": "けんぴん", "meaning": "goods inspection"}, {"term": "立ち上げ", "reading": "たちあげ", "meaning": "starting up (a line)"}]'::jsonb, '[{"template": "email_thread", "title": "Re: 先日の納品について", "meta": [{"label": "差出人", "value": "あさひ工業 資材課 鈴木"}, {"label": "宛先", "value": "山川商事 営業部 佐藤様"}, {"label": "件名", "value": "Re: 先日の納品について"}, {"label": "日時", "value": "9月11日 10時30分"}], "blocks": [{"type": "paragraph", "text": "佐藤様　お世話になっております。あさひ工業の鈴木です。"}, {"type": "paragraph", "text": "先日の納品ですが、品物そのものに問題はございませんでした。数量も注文どおりで、状態も良好です。"}, {"type": "paragraph", "text": "ただ、到着が午後4時を過ぎておりまして、当日中の検品ができませんでした。検品は翌朝になり、その分ラインの立ち上げが1日ずれております。"}, {"type": "quoted_message", "sender": "山川商事 佐藤", "sent_at": "9月10日 18時", "depth": 1, "text": "本日、ご注文の品を納品いたしました。ご確認のほどよろしくお願いいたします。"}]}]'::jsonb, '[]'::jsonb, null, null),
       ('5165a67c41', 'sougou_dokkai_J2_001', 'sougou_dokkai', 'J2', 'internal_change+junior_to_senior+infer_next_step@J2', 'internal_change', 'junior_to_senior', 'infer_next_step', 'written', null, null, null, '手続き変更後にすべきこと', '9月中に使った経費がまだ精算されていない社員は、まず何をすべきですか。', 0, '通知には、新しい手続きと、移行期間の扱いの二つが書かれている。9月分は移行前の分なので、紙で9月30日までに出す。新しい手続きの条項だけを読むと、10月を待つ答えを選んでしまう。', 'The notice describes a new procedure and a transitional rule; September falls under the second.', '[{"term": "精算", "reading": "せいさん", "meaning": "settlement of expenses"}, {"term": "原本", "reading": "げんぽん", "meaning": "the original document"}]'::jsonb, '[{"template": "memo_notice", "title": "経費精算の手続き変更について", "meta": [{"label": "発信者", "value": "経理部"}, {"label": "発信日", "value": "9月1日"}, {"label": "対象", "value": "全社員"}], "blocks": [{"type": "paragraph", "text": "10月1日より、経費精算の手続きを次のとおり変更します。"}, {"type": "numbered", "items": ["紙の申請書は廃止し、社内システムから申請してください。", "領収書は撮影して添付してください。原本の提出は不要です。", "9月分までの精算は、9月30日までに紙の申請書で提出してください。"]}, {"type": "callout", "tone": "warning", "text": "9月30日を過ぎた紙の申請書は受け付けられません。"}]}]'::jsonb, '[]'::jsonb, null, null),
       ('d0f01bbe08', 'sougou_dokkai_J2_001', 'sougou_dokkai', 'J2', 'order_exchange+subordinate_to_superior+infer_intent@J2', 'order_exchange', 'subordinate_to_superior', 'infer_intent', 'written', null, null, null, '先方が本当に求めていること', '先方がこのメールで求めていることは何ですか。', 3, '丁寧な依頼は、第一希望と代案を並べて書くことが多い。ここでは「1回にまとめる」が第一希望、「日程だけ早めに」が代案。金額は了承済みと明記されており、論点になっていない。理由として述べられた倉庫の事情を依頼と取り違えないこと。', 'A polite request states a first choice and a fallback; the stated reason is not itself the ask.', '[{"term": "了承", "reading": "りょうしょう", "meaning": "consent / approval"}, {"term": "受け入れ体制", "reading": "うけいれたいせい", "meaning": "capacity to receive"}]'::jsonb, '[{"template": "email_thread", "title": "Re: お見積りの件", "meta": [{"label": "差出人", "value": "みどり物産 購買部 田中"}, {"label": "宛先", "value": "山川商事 営業部 佐藤様"}, {"label": "件名", "value": "Re: お見積りの件"}, {"label": "日時", "value": "9月12日 15時"}], "blocks": [{"type": "paragraph", "text": "お見積り、ありがとうございました。"}, {"type": "paragraph", "text": "金額については社内で了承が得られました。ただ、納入が3回に分かれる点について、倉庫の受け入れ体制の都合で、1回にまとめていただくことは可能でしょうか。"}, {"type": "paragraph", "text": "難しいようでしたら、回数はそのままで結構ですので、各回の日程だけ早めにお知らせいただけますと助かります。"}, {"type": "quoted_message", "sender": "山川商事 佐藤", "sent_at": "9月10日 11時", "depth": 1, "text": "ご依頼の件、お見積書を添付いたします。納入は3回に分けて行う想定でございます。"}]}]'::jsonb, '[]'::jsonb, null, null),
       ('239d687cb0', 'sougou_dokkai_J2_001', 'sougou_dokkai', 'J2', 'project_update+subordinate_to_superior+infer_risk@J2', 'project_update', 'subordinate_to_superior', 'infer_risk', 'written', null, null, null, '報告すべき問題', '上司に報告すべき問題はどれですか。', 1, '表は予定と実績を並べており、食い違っているのは試験準備の行だけ。組み立ての50パーセントは予定どおりで、数字が小さいことと遅れていることは別。担当者の別件対応は原因であって、報告すべき問題そのものではない。', 'Only one row differs between plan and actual; a small number that matches the plan is not a risk.', '[{"term": "実績", "reading": "じっせき", "meaning": "actual (as against plan)"}, {"term": "未着手", "reading": "みちゃくしゅ", "meaning": "not yet started"}]'::jsonb, '[{"template": "progress_report", "title": "案件K 週次報告", "meta": [{"label": "報告者", "value": "技術部 川口"}, {"label": "報告日", "value": "9月12日"}, {"label": "案件", "value": "案件K"}], "blocks": [{"type": "paragraph", "text": "今週の進捗は次のとおりです。"}, {"type": "table", "columns": ["工程", "予定", "実績"], "rows": [["設計", "完了", "完了"], ["部材手配", "完了", "完了"], ["組み立て", "50パーセント", "50パーセント"], ["試験準備", "着手", "未着手"]]}, {"type": "paragraph", "text": "試験準備は、担当者が別件の対応に入っているため着手できていません。試験そのものの日程は動かせません。"}]}]'::jsonb, '[]'::jsonb, null, null),
       ('bcf3ee0bf3', 'sougou_dokkai_J2_001', 'sougou_dokkai', 'J2', 'scheduling+subordinate_to_superior+compare_versions@J2', 'scheduling', 'subordinate_to_superior', 'compare_versions', 'written', null, null, null, '変更前後を読み比べる', '変更の結果、研修はどうなりますか。', 3, '動いたのは1日目だけで、3日に前倒しになった。2日目は「変更なし」なので、引用部分にあるもとの7日のまま。会場は2日とも本社ホールに変わる。変更の一覧は、変更のない行も並べて書くことが多く、そこを読み飛ばすと2日とも動いたと思い込む。', 'Only the first day moves; the unchanged line leaves the second on the 7th, which only the quoted original states.', '[{"term": "会場", "reading": "かいじょう", "meaning": "venue"}, {"term": "案内", "reading": "あんない", "meaning": "notification / guidance"}]'::jsonb, '[{"template": "email_thread", "title": "Re: 研修日程の変更", "meta": [{"label": "差出人", "value": "人事部 山本"}, {"label": "宛先", "value": "営業部 各位"}, {"label": "件名", "value": "Re: 研修日程の変更"}, {"label": "日時", "value": "9月10日 14時"}], "blocks": [{"type": "paragraph", "text": "先にご案内した研修日程を、次のとおり変更します。"}, {"type": "bullets", "items": ["1日目：10月6日（月）→ 10月3日（金）", "2日目：変更なし", "会場：第一研修室 → 本社ホール"]}, {"type": "quoted_message", "sender": "人事部 山本", "sent_at": "9月2日 10時", "depth": 1, "text": "10月の研修は、6日（月）と7日（火）の2日間、第一研修室で行います。2日とも午前9時開始です。"}]}]'::jsonb, '[]'::jsonb, null, null),
       ('7438c97fc1', 'sougou_dokkai_J2_001', 'sougou_dokkai', 'J2', 'project_update+junior_to_senior+infer_owner@J2', 'project_update', 'junior_to_senior', 'infer_owner', 'written', null, null, null, '誰が対応すべきか', 'この議事録のあと、次に動くのは誰ですか。', 0, '議事録は三つの担当を定め、最後の段落で技術の確認が済んだことと、検査への影響がないことを述べている。残っているのは価格の見直しで、これは営業の担当。項目の一覧だけを見ると3人とも動くように見える。', 'The list assigns three tasks; the closing paragraph retires two of them.', '[{"term": "軽微", "reading": "けいび", "meaning": "minor"}, {"term": "見直し", "reading": "みなおし", "meaning": "review / revision"}]'::jsonb, '[{"template": "meeting_minutes", "title": "第四回 案件N 打ち合わせ 議事録", "meta": [{"label": "日時", "value": "9月9日 16時"}, {"label": "場所", "value": "第二会議室"}, {"label": "出席者", "value": "課長、佐藤（営業）、川口（技術）、山本（品質）"}], "blocks": [{"type": "numbered", "items": ["先方からの仕様変更の申し出は、内容を技術で確認のうえ受けるかどうかを決める。", "受ける場合の価格の見直しは営業が行う。", "検査項目への影響は品質が確認する。"]}, {"type": "paragraph", "text": "技術より、変更内容は軽微で対応可能との回答があった。検査項目にも影響しない見込み。"}]}]'::jsonb, '[]'::jsonb, null, null)
on conflict (id) do update set
...
values ('5d536c8392', 0, '納品された品物に不具合があり、そのために検品をやり直したこと', 'unsupported_but_plausible', '苦情の原因として最も想像しやすいが、「品物そのものに問題はございませんでした」と明確に否定されている。', null),
       ...
       ('5165a67c41', 0, '9月30日までに、紙の申請書で提出する。', 'correct', '三つ目の項目が9月分までの精算を紙で9月30日までと定めており、注記がその期限を過ぎたものは受け付けないと念を押している。', null),
       ('5165a67c41', 1, '10月1日を待って、社内システムから申請する。', 'wrong_timeframe', '新しい手続きは10月1日からだが、9月分は紙で9月中に出すよう別に定められている。', null),
       ('5165a67c41', 2, '領収書を撮影して、社内システムに添付する。', 'stated_but_answers_different_question', '変更後の手続きとしては正しいが、9月分の精算にはあてはまらない。', null),
       ...
       ('bcf3ee0bf3', 0, '10月3日と4日の2日間、本社ホールで行う。', 'unsupported_but_plausible', '2日とも前にずれたと読めば自然だが、2日目は「変更なし」と明記されている。', null),
       ('bcf3ee0bf3', 1, '10月6日と7日の2日間、本社ホールで行う。', 'wrong_timeframe', '会場の変更だけを反映し、1日目が3日に動いたことを反映していない。', null),
       ('bcf3ee0bf3', 2, '10月3日と7日の2日間、第一研修室で行う。', 'surface_keyword_match', '日程は正しいが、会場は本社ホールに変わっている。引用部分の会場をそのまま拾っている。', null),
       ('bcf3ee0bf3', 3, '10月3日と7日の2日間、本社ホールで行う。', 'correct', '1日目が3日に動き、2日目は「変更なし」で、引用部分にあるもとの7日のまま。会場は本社ホールに変わっている。', null),
