...
values ('5d536c8392', 'sougou_dokkai_J2_001', 'sougou_dokkai', 'J2', 'client_escalation+staff_to_visitor+infer_cause@J2', 'client_escalation', 'staff_to_visitor', 'infer_cause', 'written', null, null, null, '苦情の本当の理由', '先方が困っているのは、何が原因ですか。', 2, '「品物そのものに問題はございませんでした」「数量も注文どおり」と、何が原因でないかを先に並べてから「ただ、」で本題に入る型。原因は到着時刻で、そのために検品が翌朝になり、立ち上げが1日ずれている。丁寧な苦情ほど、原因は「ただ」のあとに来る。', 'A polite complaint clears away what is not the problem first; the cause follows ただ.', '[{"term": "検品", "reading": "けんぴん", "meaning": "goods inspection"}, {"term": "立ち上げ", "reading": "たちあげ", "meaning": "starting up (a line)"}]'::jsonb, '[{"template": "email_thread", "title": "Re: 先日の納品について", "meta": [{"label": "差出人", "value": "あさひ工業 資材課 鈴木"}, {"label": "宛先", "value": "山川商事 営業部 佐藤様"}, {"label": "件名", "value": "Re: 先日の納品について"}, {"label": "日時", "value": "9月11日 10時30分"}], "blocks": [{"type": "paragraph", "text": "佐藤様　お世話になっております。あさひ工業の鈴木です。"}, {"type": "paragraph", "text": "先日の納品ですが、品物そのものに問題はございませんでした。数量も注文どおりで、状態も良好です。"}, {"type": "paragraph", "text": "ただ、到着が午後4時を過ぎておりまして、当日中の検品ができませんでした。検品は翌朝になり、その分ラインの立ち上げが1日ずれております。"}, {"type": "quoted_message", "sender": "山川商事 佐藤", "sent_at": "9月10日 18時", "depth": 1, "text": "本日、ご注文の品を納品いたしました。ご確認のほどよろしくお願いいたします。"}]}]'::jsonb, '[]'::jsonb, null, null),
       ...
       ('bcf3ee0bf3', 'sougou_dokkai_J2_001', 'sougou_dokkai', 'J2', 'scheduling+subordinate_to_superior+compare_versions@J2', 'scheduling', 'subordinate_to_superior', 'compare_versions', 'written', null, null, null, '変更前後を読み比べる', '変更の結果、研修はどうなりますか。', 3, '1日目だけが7日に動き、2日目は「変更なし」でもともと7日。結果として2日が1日に重なる。変更の一覧は、変更のない行も並べて書くことが多く、そこを読み飛ばすと2日間のままだと思い込む。', 'Only one of the two days moves, onto the other; the unchanged line is the one that decides it.', '[{"term": "会場", "reading": "かいじょう", "meaning": "venue"}, {"term": "案内", "reading": "あんない", "meaning": "notification / guidance"}]'::jsonb, '[{"template": "email_thread", "title": "Re: 研修日程の変更", "meta": [{"label": "差出人", "value": "人事部 山本"}, {"label": "宛先", "value": "営業部 各位"}, {"label": "件名", "value": "Re: 研修日程の変更"}, {"label": "日時", "value": "9月10日 14時"}], "blocks": [{"type": "paragraph", "text": "先にご案内した研修日程を、次のとおり変更します。"}, {"type": "bullets", "items": ["1日目：10月6日（月）→ 10月7日（火）", "2日目：10月7日（火）→ 変更なし", "会場：第一研修室 → 本社ホール"]}, {"type": "quoted_message", "sender": "人事部 山本", "sent_at": "9月2日 10時", "depth": 1, "text": "10月の研修は、6日（月）と7日（火）の2日間、第一研修室で行います。2日とも午前9時開始です。"}]}]'::jsonb, '[]'::jsonb, null, null),
...
values ('5d536c8392', 0, '納品された品物に不具合があったこと', 'unsupported_but_plausible', '苦情の原因として最も想像しやすいが、「品物そのものに問題はございませんでした」と明確に否定されている。', null),
       ...
       ('bcf3ee0bf3', 0, '10月7日と8日の2日間、本社ホールで行う。', 'unsupported_but_plausible', '1日ずつ後ろにずれたと読めば自然だが、2日目は「変更なし」と明記されている。', null),
       ('bcf3ee0bf3', 1, '10月6日と7日の2日間、本社ホールで行う。', 'wrong_timeframe', '会場の変更だけを反映し、1日目が7日に動いたことを反映していない。', null),
       ('bcf3ee0bf3', 2, '10月7日の1日だけ、第一研修室で行う。', 'surface_keyword_match', '日程は正しいが、会場は本社ホールに変わっている。引用部分の会場をそのまま拾っている。', null),
       ('bcf3ee0bf3', 3, '10月7日の1日だけ、本社ホールで行う。', 'correct', '1日目が7日に動き、2日目はもともと7日で変更なし。同じ日になるので、実質1日になる。', null),
