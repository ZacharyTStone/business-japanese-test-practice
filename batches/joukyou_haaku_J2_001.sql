...
values ('4bff58fe54', 0, '身分証が確認できたので、2時からの利用を認める。', 'ignores_the_document', '身分証の条件は満たしているが、前日までの申し込みという条件を満たしていない。', null),
       ('4bff58fe54', 1, '正午から1時は閉室なので、1時以降に来るよう伝える。', 'right_action_wrong_condition', '閉室の条件は本当だが、2時の希望はもともとその時間帯を外しており、断る理由にならない。', null),
       ...
       ('5183736ad7', 0, '第一会議室の13時からを取る。', 'correct', '午後の空きは第一会議室の13時からと応接室の15時からの2つ。応接室は社外の方がいる場合に限られるので、残るのはここだけ。', null),
       ('5183736ad7', 1, '応接室の15時からを取る。', 'ignores_the_document', '表の上では空いているが、注記が応接室の利用を社外の方がいる場合に限っており、社内だけの集まりには使えない。', null),
       ('5183736ad7', 2, '第一会議室の10時からを取る。', 'ignores_the_request', '表のうえでは空いているが、頼まれたのは午後で、1時からでも3時からでも構わないと言われている。', null),
       ('5183736ad7', 3, '第二会議室を使えるよう、人事部に面接をずらしてもらう。', 'wrong_action_owner', '部屋を空けさせる相手が違う。予約表では第二会議室が終日「採用面接」で埋まっており、空いている部屋があるのに他部署の予定を動かしてもらう話ではない。', null),
       ('d6bb06d3b8', 0, '午後3時ちょうどに始める。', 'right_action_wrong_condition', '停止そのものは終わっているが、前後30分は不安定と書かれており、1時間の作業には向かない。', null),
       ('d6bb06d3b8', 1, '午前9時前の、8時半に始める。', 'ignores_the_document', '停止前ではあるが、こちらも「前後30分」に入っており、しかも1時間の作業は停止時刻をまたいでしまう。', null),
       ('d6bb06d3b8', 2, '情報システム部に停止を延期してもらう。', 'wrong_action_owner', '通知は全社員あての決定事項で、1件の作業のために動かすものではない。', null),
       ('d6bb06d3b8', 3, '午後3時半より後に始める。', 'correct', '停止は午後3時までで、前後30分は不安定になるとあるので、確実に動くのは3時半以降。', null),
       ...
       ('1deef9802d', 2, '課長が承認したかどうか', 'wrong_action_owner', '3点を超えるので承認は必要だが、それは電話のあとに自分が課長から取るもので、相手に聞くことではない。', null),
       ('1deef9802d', 3, '土日を挟んだ場合に受け取れるかどうか', 'right_action_wrong_condition', '繰り越しの定めは本当だが、金曜の申込なら発送は翌営業日で、相手に確認を求める点ではない。', null),
       ('2a8263856b', 0, '応接室へ案内する。', 'correct', '予定表の13時の行に、あさひ工業 鈴木様の場所として応接室が書かれている。', null),
       ('2a8263856b', 1, '第一会議室へ案内する。', 'ignores_the_request', '予定表にある部屋ではあるが、それは10時のみどり物産の行で、受付に来ているのは鈴木様。', null),
       ('2a8263856b', 2, '人事部の担当者に、代わりに案内してもらう。', 'wrong_action_owner', '人事部が対応するのは15時の求職者で、この来客の案内を頼む相手ではない。', null),
       ('2a8263856b', 3, '佐藤が戻るまで受付で待ってもらう。', 'ignores_the_document', '予定表は場所を定めており、担当者の不在は案内先を変える理由にならない。', null),
       ('4ff5cfd876', 0, '経理部が、総務部に返す。', 'correct', '返却はその日の最後に使った部署が行うと定められており、最後は経理部。終わるのは5時ごろで6時前なので、返す先は総務部。', null),
       ('4ff5cfd876', 1, '自分の部署が、総務部に返す。', 'wrong_action_owner', '鍵を受け取るのは予約した部署だが、返すのは最後に使った部署で、規則が分けて書かれている。', null),
       ('4ff5cfd876', 2, '経理部が、警備室に返す。', 'right_action_wrong_condition', '警備室に返すのは午後6時以降の場合で、終わるのは5時ごろなのでこの条件に当たらない。', null),
