...
values ('807d62e9b4', 'sougou_dokkai_J1_001', 'sougou_dokkai', 'J1', 'scheduling+subordinate_to_superior+infer_owner@J1', 'scheduling', 'subordinate_to_superior', 'infer_owner', 'written', null, null, null, '日程調整を誰が引き取るか', '先方への返事は、誰がどのようにすることになりますか。', 2, '課長のメールは、先方の候補日を転送したうえで、自分の都合を伝え、調整と返事を佐藤に頼んでいる。先方の希望する技術担当の同席は、佐藤が確かめる条件の一つであって、技術担当が返事をするわけではない。課長の空きは先方の希望する午後と合わないので、課長自身が日程を決めて返事をする流れにもならない。', 'The manager forwards the request, states his own constraints and delegates the reply; the engineer''s presence is a condition to check, not the reply itself.', '[{"term": "同席", "reading": "どうせき", "meaning": "attending together"}, {"term": "踏まえる", "reading": "ふまえる", "meaning": "to take into account"}]'::jsonb, '[{"template": "email_thread", "title": "Re: 打ち合わせ日程のご相談", "meta": [{"label": "差出人", "value": "営業部 課長 川口"}, {"label": "宛先", "value": "営業部 佐藤"}, {"label": "件名", "value": "Re: 打ち合わせ日程のご相談"}, {"label": "日時", "value": "9月9日 9時10分"}], "blocks": [{"type": "paragraph", "text": "佐藤さん　下記、先方から日程の候補が来ています。私は14日は終日外出、16日は午前しか空いていません。先方は技術の話も聞きたいそうなので、その点も踏まえて調整をお願いします。返事は今日中に。"}, {"type": "quoted_message", "sender": "あさひ工業 鈴木", "sent_at": "9月8日 17時20分", "depth": 1, "text": "川口様　次回の打ち合わせですが、14日か16日の午後でいかがでしょうか。可能でしたら、技術のご担当の方にもご同席いただけると助かります。"}]}]'::jsonb, '[]'::jsonb, null, null),
       ('a151810e90', 'sougou_dokkai_J1_001', 'sougou_dokkai', 'J1', 'project_update+junior_to_senior+infer_risk@J1', 'project_update', 'junior_to_senior', 'infer_risk', 'written', null, null, null, '報告書に隠れた日程の問題', '先輩に報告しておくべき問題は何ですか。', 0, '報告書は「予定どおり」と書くが、表と備考を突き合わせると、検査の開始日より測定器の戻りが5日遅い。書き手はそれを問題として挙げていないので、読む側が気づいて報告する必要がある。製造の8割は予定の範囲内、設計は完了済みで、人手の話は出ていない。', 'The report says on schedule, but the instrument returns five days after inspection is due to start; the risk is implied by two lines, not stated.', '[{"term": "校正", "reading": "こうせい", "meaning": "calibration"}, {"term": "着手", "reading": "ちゃくしゅ", "meaning": "starting (work)"}]'::jsonb, '[{"template": "progress_report", "title": "案件N 進捗報告", "meta": [{"label": "報告者", "value": "技術部 後藤"}, {"label": "報告日", "value": "9月22日"}, {"label": "案件", "value": "案件N（ひかり製作所）"}], "blocks": [{"type": "paragraph", "text": "全体としては予定どおり進んでいます。"}, {"type": "table", "columns": ["工程", "状況", "予定"], "rows": [["設計", "完了", "9月5日 完了済み"], ["製造", "進行中（8割）", "9月30日 完了予定"], ["検査", "未着手", "10月1日 開始予定"]]}, {"type": "bullets", "items": ["検査に使う測定器は、9月末まで業者で校正中。戻りは10月6日の見込み。", "納品は10月20日で先方と合意済み。"]}]}]'::jsonb, '[]'::jsonb, null, null)
on conflict (id) do update set
