...
values ('01948b5471', 0, 'カタログだけ', 'combines_wrong_pair', '議事録のとおりではあるが、会話の最後で価格表も送ることになった。', null),
       ...
       ('dfb5fc07a2', 1, '10月11日の土曜日', 'correct', '課長が費用がかかっても休日にすると決め、資料で休日の案Aは10月11日の土曜日。', null),
       ('dfb5fc07a2', 2, '10月14日の火曜日', 'combines_wrong_pair', '資料で安いほうの案Bの日程だが、平日で事務所が使えないため、課長が退けている。', null),
