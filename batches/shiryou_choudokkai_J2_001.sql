...
values ('013fa68b2a', 0, '24本', 'ignores_the_spoken_change', '見積書に書かれている数量のままで、口頭で告げられた「倍に」を反映していない。', null),
       ...
       ('f760e4e239', 0, '9月24日', 'correct', '18日（土）の翌々営業日。19日（日）、20日（日曜と述べられた日）、21日と22日の休業日を飛ばすと、営業日は23日と24日になる。', null),
       ...
       ('0c022ece93', 2, '24万4000円', 'surface_keyword_match', '追加分を単価ではなく1人あたり2万4000円で計算した額で、注記の「同じ単価で」に反している。', null),
       ('0c022ece93', 3, '24万円', 'correct', '12名分で、研修が1万8000円×十二の21万6000円、教材が2000円×十二の2万4000円。合わせて24万円。', null),
