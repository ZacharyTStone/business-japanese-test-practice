...
values ('5f2adf082b', 0, '出発日が十月十四日以前にあたるため、システムではなく紙の申請書で出し直す必要があると伝える。', 'correct', '名古屋出張は国内だが、出発日が来週の八日で十四日以前にあたり、通知の但し書きによりシステムではなく紙の申請書が必要だから。', null),
       ('5f2adf082b', 1, '出発日が十月十五日以降の出張なので、システムのままで良いと伝える。', 'right_action_wrong_condition', 'システムでの申請が認められるのは出発日が十五日以降の場合であり、先輩の出張は来週の八日でこの条件を満たしていない。', null),
       ('5f2adf082b', 2, 'すでにトリップナビへの入力が済んでいるので、そのままで問題ないと伝える。', 'ignores_the_document', '新方式での入力が済んでいることだけを見ており、出発日が十四日以前は紙の申請書が必要という但し書きを見落としている。', null),
