...
values ('5fea125b8c', 0, '週2日以内なので、木曜と金曜の両方を認める。', 'ignores_the_document', '相談の内容だけに答えており、通知にある来客日の除外も、入社後3か月未満の但し書きも見ていない。', null),
       ('5fea125b8c', 1, '人事部から山田さんに直接、対象外だと伝えてもらう。', 'wrong_action_owner', '判断の中身は合っているが、部下の相談に答えるのは所属長で、通知にも人事部が個別に伝えるとは書かれていない。', null),
       ('5fea125b8c', 2, '先月入社で入社後3か月未満なので、どちらの日も対象外だと伝える。', 'correct', '通知の但し書きが入社後3か月未満の人を対象外としており、課長の話から山田さんが先月入社だと分かる。日数や曜日を見る前に、そもそも対象にならない。', null),
       ('5fea125b8c', 3, '金曜は来客対応の日にあたるので、木曜だけを認める。', 'right_action_wrong_condition', '来客のある日を除く条件は本当だが、山田さんは入社後3か月未満で制度の対象外なので、木曜も認められない。', null),
       ('b7865a8ee7', 0, '本社3階のサービス窓口へ、平日の9時から17時の間に持ち込むよう案内する。', 'correct', '測定器は精密機器として本社の窓口が受け付けると通知にあり、土日は受け付けないので、明日の土曜ではなく平日を案内する。', null),
       ('b7865a8ee7', 1, '本社3階のサービス窓口へ、明日の土曜に持ち込むよう案内する。', 'right_action_wrong_condition', '持ち込み先は合っているが、通知は土日祝の受け付けをしないと定めており、お客様の希望する日は使えない。', null),
