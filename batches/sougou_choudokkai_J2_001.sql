...
values ('7bc31b17c2', 'sougou_choudokkai_J2_001', 'sougou_choudokkai', 'J2', 'project_meeting+superior_to_subordinate+summarise_outcome@J2', 'project_meeting', 'superior_to_subordinate', 'summarise_outcome', 'in_person', 'scene_meeting_room_table', null, null, '改修の範囲がどうなったか', '改修は結局どうなりましたか。', 2, '議事録は「4階の扱いは移転計画の確定後に見直す」としていたが、会話の中で移転の見込みが述べられ、その場で4階が外された。議事録だけを読むと両方、会話だけでは予算の扱いが分からない。', 'The minutes defer a decision; the conversation takes it. Neither alone is the outcome.', '[{"term": "改修", "reading": "かいしゅう", "meaning": "refurbishment"}, {"term": "着工", "reading": "ちゃっこう", "meaning": "start of construction"}]'::jsonb, '[{"template": "meeting_minutes", "title": "第三回 設備改修 打ち合わせ 議事録", "meta": [{"label": "日時", "value": "9月4日 10時"}, {"label": "場所", "value": "第一会議室"}, {"label": "出席者", "value": "課長、佐藤、川口"}], "blocks": [{"type": "numbered", "items": ["改修の対象は3階および4階とする。", "予算は800万円。着工は11月。", "4階の扱いは、移転計画の確定後に見直す。"]}]}]'::jsonb, '[{"speaker_role": "課長", "text": "議事録では、改修は三階と四階の両方でしたね。", "clip_id": "d2feb65099dc43fe"}, {"speaker_role": "先輩社員", "text": "はい。ただ、四階は来年の移転で使わなくなる見込みです。", "clip_id": "0a2c9c55f0b8bc3c"}, {"speaker_role": "課長", "text": "では四階は外しましょう。三階だけにします。", "clip_id": "769dc4b961ffe328"}, {"speaker_role": "後輩社員", "text": "予算はどういたしますか。三階だけですと半分ほど余りますが。", "clip_id": "2044771a57d9975c"}, {"speaker_role": "課長", "text": "余った分は戻します。追加の工事はしません。", "clip_id": "9ba4d85122c8d1d8"}]'::jsonb, '81b24ed799748e41', null),
       ('808b6996bf', 'sougou_choudokkai_J2_001', 'sougou_choudokkai', 'J2', 'video_review+peer_to_peer+identify_action_owner@J2', 'video_review', 'peer_to_peer', 'identify_action_owner', 'video', 'scene_video_call_laptop', null, null, '誰が先方に連絡するか', '先方への連絡と資料の更新は、それぞれ誰がすることになりましたか。', 0, '議事録の表では連絡が山本、資料が川口だが、会話で出張を理由に入れ替わっている。出席者名と会話中の呼び方を突き合わせないと、どちらがどちらか決まらない。社内共有は入れ替えの対象になっていない。', 'The table assigns; the conversation swaps two of the three rows, and only two.', '[{"term": "出張", "reading": "しゅっちょう", "meaning": "business trip"}, {"term": "共有", "reading": "きょうゆう", "meaning": "sharing (internally)"}]'::jsonb, '[{"template": "meeting_minutes", "title": "第二回 レビュー 議事録", "meta": [{"label": "日時", "value": "9月8日 14時"}, {"label": "場所", "value": "オンライン"}, {"label": "出席者", "value": "山本、川口"}], "blocks": [{"type": "table", "columns": ["項目", "担当", "期限"], "rows": [["先方への連絡", "山本", "9月12日"], ["資料の更新", "川口", "9月15日"], ["社内共有", "山本", "9月16日"]]}]}]'::jsonb, '[{"speaker_role": "同僚A", "text": "議事録では、先方への連絡は私になっていますね。", "clip_id": "a5fc79a37ac3b334"}, {"speaker_role": "同僚B", "text": "そうなんですが、来週は出張で連絡が取りづらいのでは。", "clip_id": "798ea5f09f5d409b"}, {"speaker_role": "同僚A", "text": "確かに。では連絡はお願いできますか。", "clip_id": "3e4d1ddedd0c092f"}, {"speaker_role": "同僚B", "text": "承知しました。資料の更新はそちらでお願いします。", "clip_id": "c32a787da888ebdc"}, {"speaker_role": "同僚A", "text": "はい、資料は私が直します。", "clip_id": "f0acde8231a74a21"}]'::jsonb, '8f467d1b08b3e967', null),
       ('b9b8446b1d', 'sougou_choudokkai_J2_001', 'sougou_choudokkai', 'J2', 'video_review+superior_to_subordinate+find_the_deadline@J2', 'video_review', 'superior_to_subordinate', 'find_the_deadline', 'video', 'scene_video_call_laptop', null, null, '期限がいつになったか', '報告書の期限はいつになりましたか。', 3, '搬入の遅れで開始が1日ずれたが、期間を3日から2日に縮めたため終了日は24日のまま。期限は「その翌営業日」なので25日。資料の最終日や予備日は、どちらも期限の根拠になっていない。', 'The start slips and the duration shrinks, so the end date does not move.', '[{"term": "搬入", "reading": "はんにゅう", "meaning": "delivery into a site"}, {"term": "予備日", "reading": "よびび", "meaning": "reserve day"}]'::jsonb, '[{"template": "schedule", "title": "試験日程", "meta": [{"label": "期間", "value": "9月22日（月）〜26日（金）"}, {"label": "作成者", "value": "技術部"}], "blocks": [{"type": "table", "columns": ["日付", "予定"], "rows": [["22日（月）", "試験1日目"], ["23日（火）", "試験2日目"], ["24日（水）", "試験3日目"], ["25日（木）", "予備日"]]}]}]'::jsonb, '[{"speaker_role": "課長", "text": "予定表では、試験は二十二日から二十四日の三日間ですね。", "clip_id": "15a9d51a99d45460"}, {"speaker_role": "後輩社員", "text": "はい。ただ、装置の搬入が一日遅れまして、二十三日からになります。", "clip_id": "6dd1cf9ed90dd67d"}, {"speaker_role": "課長", "text": "三日間は必要ですか。", "clip_id": "5f94c5af5f8da526"}, {"speaker_role": "後輩社員", "text": "二日に縮められます。二十四日には終わります。", "clip_id": "473215020b5d02f5"}, {"speaker_role": "課長", "text": "分かりました。報告書はその翌営業日までに出してください。", "clip_id": "5801b8de9b67b7f7"}]'::jsonb, '230faf2d31dd06ca', null),
       ('dd4aa457b1', 'sougou_choudokkai_J2_001', 'sougou_choudokkai', 'J2', 'client_review+peer_to_peer+reconcile_document@J2', 'client_review', 'peer_to_peer', 'reconcile_document', 'in_person', 'scene_client_meeting_room', null, null, '単価の食い違いを解く', '今回の金額はいくらになりますか。', 1, '手元の書類は9月1日付で、会話によりこれが古いほうだと分かる。新しい単価は1200円、数量は200個で変わらない。資料の金額をそのまま使うと古い額になり、二つの単価を足すと値上げの意味を取り違える。', 'The document in hand is the older one; the conversation is what says so.', '[{"term": "控え", "reading": "ひかえ", "meaning": "one''s own copy"}, {"term": "値上げ", "reading": "ねあげ", "meaning": "price increase"}]'::jsonb, '[{"template": "quote_order", "title": "お見積書（部材）", "meta": [{"label": "宛先", "value": "あさひ工業株式会社 御中"}, {"label": "発行者", "value": "山川商事株式会社"}, {"label": "発行日", "value": "9月1日"}], "blocks": [{"type": "table", "columns": ["品名", "数量", "単価", "金額"], "rows": [["部材B", "200個", "1,000円", "200,000円"]]}]}]'::jsonb, '[{"speaker_role": "同僚A", "text": "先方のお手元の見積書、単価が千二百円になっていますね。", "clip_id": "6b3689d83ae683a3"}, {"speaker_role": "同僚B", "text": "こちらの控えは千円です。どちらが新しいのでしょうか。", "clip_id": "931ae91ce00eb05d"}, {"speaker_role": "同僚A", "text": "九月一日付が古いほうです。値上げのご連絡を九月五日に差し上げています。", "clip_id": "b20a47fb473e9cf4"}, {"speaker_role": "同僚B", "text": "では先方のものが新しいということですね。", "clip_id": "fe2cccf43493551f"}, {"speaker_role": "同僚A", "text": "はい。数量は二百個で、どちらの書類も同じです。", "clip_id": "f501f269d2e0ae62"}]'::jsonb, 'c4293b309817475f', null),
       ('2ee42c7c01', 'sougou_choudokkai_J2_001', 'sougou_choudokkai', 'J2', 'project_meeting+superior_to_subordinate+identify_risk@J2', 'project_meeting', 'superior_to_subordinate', 'identify_risk', 'in_person', 'scene_meeting_room_table', null, null, '何が問題として残るか', '上に報告することになったのは、どの問題ですか。', 3, '報告書の三つの懸念が、会話の中で一つずつ片づけられていく。残るのは外部検査の枠だけで、課長も「そこだけ上に報告します」と述べている。報告書だけを読むと三つとも残っているように見える。', 'The report lists three risks and the conversation closes two of them.', '[{"term": "懸念", "reading": "けねん", "meaning": "concern / risk"}, {"term": "目処が立つ", "reading": "めどがたつ", "meaning": "to have a prospect of"}]'::jsonb, '[{"template": "progress_report", "title": "案件M 進捗報告", "meta": [{"label": "報告者", "value": "営業部 佐藤"}, {"label": "報告日", "value": "9月5日"}, {"label": "案件", "value": "案件M"}], "blocks": [{"type": "paragraph", "text": "全体としては予定どおり進んでいます。懸念は次の3点です。"}, {"type": "bullets", "items": ["人員が2名不足している。", "部材Cの入荷が不透明である。", "外部検査の枠が確保できていない。"]}]}]'::jsonb, '[{"speaker_role": "課長", "text": "報告書に挙がっている三つの懸念、いまはどうなっていますか。", "clip_id": "e416e1bdf4ac4ef1"}, {"speaker_role": "先輩社員", "text": "人員は増員が決まりました。部材も代替品の目処が立っています。", "clip_id": "d615ee11b538f444"}, {"speaker_role": "課長", "text": "では残るのは検査の枠ですか。", "clip_id": "97fa20d4ef6b39e4"}, {"speaker_role": "先輩社員", "text": "はい。外部の検査機関がどこも一杯で、まだ押さえられていません。", "clip_id": "1d296e597528ea40"}, {"speaker_role": "課長", "text": "分かりました。そこだけ上に報告します。", "clip_id": "6141b77afa6f9a8a"}]'::jsonb, '1e58b90b3ce779a7', null),
       ('2bc464a7cb', 'sougou_choudokkai_J2_001', 'sougou_choudokkai', 'J2', 'handover+junior_to_senior+choose_revision@J2', 'handover', 'junior_to_senior', 'choose_revision', 'in_person', 'scene_office_desk_pair', null, null, 'どの修正を採るか', 'どちらの修正を採ることになりましたか。', 0, 'メールは二案を並べるだけで優劣を決めていない。納期が来週だという会話の情報が決め手になり、3日で終わるほうが選ばれる。来年また直すことは承知のうえで、そこまで決めたわけではない。', 'The email offers two options; only the conversation supplies the constraint that picks one.', '[{"term": "工数", "reading": "こうすう", "meaning": "man-hours / effort"}, {"term": "間に合わせ", "reading": "まにあわせ", "meaning": "a stopgap"}]'::jsonb, '[{"template": "email_thread", "title": "Re: 引き継ぎ（表示の不具合）", "meta": [{"label": "差出人", "value": "技術部 山本"}, {"label": "宛先", "value": "営業部 各位"}, {"label": "件名", "value": "Re: 引き継ぎ（表示の不具合）"}, {"label": "日時", "value": "9月9日 11時"}], "blocks": [{"type": "paragraph", "text": "表示の不具合について、直し方は2通りあります。"}, {"type": "numbered", "items": ["作りを組み直す。根本的に直るが、工数が大きい。", "表示の部分だけを当て直す。早いが、来年の更新時に再度の対応が要る。"]}]}]'::jsonb, '[{"speaker_role": "後輩社員", "text": "引き継ぎのメールに、修正案が二つ書いてありました。", "clip_id": "320ace4c40f5e058"}, {"speaker_role": "先輩社員", "text": "どちらも読みました。一つ目は時間がかかりますね。", "clip_id": "66d9898eb8d02329"}, {"speaker_role": "後輩社員", "text": "はい、二週間ほど。二つ目なら三日で終わります。", "clip_id": "a124a21779246a97"}, {"speaker_role": "先輩社員", "text": "納期は来週です。三日で終わるほうにしましょう。", "clip_id": "786de540420a845e"}, {"speaker_role": "後輩社員", "text": "ただ、二つ目は来年また直すことになります。", "clip_id": "86499ff12e38f19a"}, {"speaker_role": "先輩社員", "text": "それで構いません。今回は間に合わせが先です。", "clip_id": "63c7db719dd4e16e"}]'::jsonb, '8fe792581b5bf438', null)
on conflict (id) do update set
...
values ('7bc31b17c2', 0, '3階と4階の両方を改修する。', 'combines_wrong_pair', '議事録の一項目のままで、会話でその項目が見直されたことを反映していない。', null),
       ('7bc31b17c2', 1, '3階を改修し、余った予算で追加の工事をする。', 'unsupported_but_plausible', '余りの使い道としてはありそうだが、課長は「追加の工事はしません」と明確に否定している。', null),
       ('7bc31b17c2', 2, '3階だけを改修し、余った予算は戻す。', 'correct', '課長が「4階は外しましょう。3階だけにします」と決め、余りは「戻します」と述べている。', null),
       ('7bc31b17c2', 3, '移転計画が確定するまで、改修を待つ。', 'stated_by_wrong_speaker', '議事録には見直しの条件としてそう書かれているが、会話ではその場で4階を外すと決まっている。', null),
       ('808b6996bf', 0, '連絡は川口、資料の更新は山本。', 'correct', '議事録の割り当てを、会話の中で2人が入れ替えている。連絡を引き受けたのが川口、資料を直すと言ったのが山本。', null),
       ...
       ('b9b8446b1d', 0, '9月24日', 'combines_wrong_pair', '試験が終わる日で、報告書の期限ではない。', null),
       ('b9b8446b1d', 1, '9月26日', 'unsupported_but_plausible', '予定表の期間の最終日だが、期限は試験の終了日から数えると定められている。', null),
       ('b9b8446b1d', 2, '9月27日', 'wrong_action_owner', '予備日の翌日にあたるが、予備日は使われず、そもそも誰も予備日に触れていない。', null),
       ('b9b8446b1d', 3, '9月25日', 'correct', '試験は24日に終わり、報告書はその翌営業日。24日が水曜なので翌営業日は木曜の25日。', null),
       ('dd4aa457b1', 0, '20万円', 'combines_wrong_pair', '手元の見積書の金額そのままで、この書類が古いほうだと会話で分かっている。', null),
       ('dd4aa457b1', 1, '24万円', 'correct', '新しいのは1200円のほうで、数量は200個のまま。1200円×200個で24万円。', null),
       ('dd4aa457b1', 2, '44万円', 'unsupported_but_plausible', '二つの単価を足して計算した額で、値上げは置き換えであって加算ではない。', null),
       ('dd4aa457b1', 3, '12万円', 'wrong_action_owner', '新しい単価に100個を掛けた額で、数量は「どちらの書類も同じ」と200個で確認されている。', null),
       ('2ee42c7c01', 0, '人員が2名不足していること', 'stated_by_wrong_speaker', '報告書に載っている懸念だが、会話では先輩が増員の決定を述べており、残っている問題として挙げたのは検査の枠のほうだけ。', null),
       ...
       ('2bc464a7cb', 0, '表示の部分だけを当て直し、来年に改めて対応する。', 'correct', '納期が来週であることを理由に3日で終わるほうが選ばれ、来年また直すことも承知のうえだと述べられている。', null),
       ('2bc464a7cb', 1, '作りを組み直して、根本的に直す。', 'combines_wrong_pair', 'メールに書かれた選択肢だが、2週間かかるため納期に間に合わないと会話で退けられている。', null),
